...
class oficial extends interna {
	...
	function masWhereLocal(tabla) {
		return this.ctx.oficial_masWhereLocal(tabla);
	}
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
function oficial_exportarTabla(tabla:String, nomTabla:String, tablaGeneral:Boolean)
{
	...
	var where = "";
	if (!this.cursor().valueBuffer("subirtodo"))
		where = "modificado = true";
	
	var masWhere = this.iface.masWhereLocal(tabla);
	if(masWhere && masWhere != "")
		where += masWhere;
...
*/
function oficial_eliminarObsoletos(tabla)
{
	var util:FLUtil = new FLUtil();
...
function oficial_masWhereLocal(tabla)
{
	return "";
}
//// OFICIAL /////////////////////////////////////////////////////
